				...
				<div class="card-body">
					...
					<form action="" method="post">
						...
						<div class="mb-3">
							...
							<input type="number" class="form-control" name="stok_produk" id="stok" placeholder="Masukkan Stok Produk" value="<?= $produk['stok_produk'] ?>" />
							<small class="text-danger"><?= form_error('stok_produk') ?></small>
						</div>
						<div class="mb-3">
							<label for="harga" class="form-label">Harga Produk</label>
							<input type="number" class="form-control" name="harga_produk" id="harga" placeholder="Masukkan harga Produk" value="<?= $produk['harga_produk'] ?>" />
